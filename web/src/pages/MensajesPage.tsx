...
Notamos que llevas varios días sin ingresar a la plataforma y queremos acompañarte para que no te atrases en tu proceso de formación de la ficha {{ficha}}.
                ...
                <>
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Button size="sm" variant="outline" className="text-xs gap-1.5"
                      ...
                      {syncJobId ? "Sincronizando..." : "Sincronizar emails desde la plataforma"}
                    </Button>
                            ...
                            return (
                              <tr key={a.id} className="hover:bg-gray-50">
                                ...
                                <td className="px-2 py-1.5 text-gray-600">
                                  {a.email || (
                                    <span className="text-amber-600 inline-flex items-center gap-1" title="Sin email — sincroniza desde la plataforma">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex gap-3">
                  ...
                  <label className="flex items-center gap-1.5 text-sm cursor-pointer">
                    ...
                    Mensaje interno de la plataforma
                  </label>
                </div>
              </div>
          ...
          <DialogContent className="max-w-md">
            ...
            <div className="space-y-3">
              <div className="rounded-md bg-gray-50 border border-gray-200 p-2 text-xs text-gray-600 space-y-0.5">
                ...
                <p><span className="font-semibold">Canal:</span> {canal === "email" ? "Correo electrónico" : "Mensaje interno de la plataforma"}</p>
